...
Parqueoimagen parqueoFromJson(String str) => Parqueoimagen.fromJson(json.decode(str));

String parqueoToJson(Parqueoimagen data) => json.encode(data.toJson());
...
class Parqueoimagen {
  ...
  String controlPagos;
  String imagenAuto;
  List<Parqueoimagen> toList = [];

  factory Parqueoimagen.fromJson(Map<String, dynamic> json) => Parqueoimagen(
  ...
  Parqueoimagen.fromJsonList(List<dynamic> jsonList) {
    if (jsonList == null) return;
    jsonList.forEach((item) {
      Parqueoimagen parqueo = Parqueoimagen.fromJson(item);
      toList.add(parqueo);
    });
  }
