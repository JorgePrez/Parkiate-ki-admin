...
Servicioadminimagen servicioFromJson(String str) =>
    Servicioadminimagen.fromJson(json.decode(str));

String servicioToJson(Servicioadminimagen data) => json.encode(data.toJson());

class Servicioadminimagen {
  String idServicio;
  String idParqueo;
  String direccion;
  ...
  //imagen_auto"
  String imagenAuto;
  List<Servicioadminimagen> toList = [];
  ...
  factory Servicioadminimagen.fromJson(Map<String, dynamic> json) => Servicioadminimagen(
  ...
  Servicioadminimagen.fromJsonList(List<dynamic> jsonList) {
    if (jsonList == null) return;
    jsonList.forEach((item) {
      Servicioadminimagen servicio = Servicioadminimagen.fromJson(item);
      toList.add(servicio);
    });
  }
