...
class _ChooseSlotScreenTestState extends State<ChooseSlotScreenTest> {
  ...
  DatabaseReference _dhtRef = FirebaseDatabase.instance
      .reference()
      .child('/Parking_Status/-Mq73KmXyn-fx7tlnIQn/-N-yzFejDQpGWS6KccmN');
                    ...
                    onPressed: () {
                      if (estado) {
                        ...
                        Fluttertoast.showToast(
                            msg: 'Espacio Libre', //Strings.slotIsNotAvailable,
                        ...
                        Fluttertoast.showToast(
                            msg:
                                'Espacio Ocupado', //Strings.slotIsNotAvailable,
        ...
        Container(
          ...
          child: GridView.count(
            ...
            children: List.generate(SlotList.list().length, (index) {
              SlotR slot = SlotList.list()[index];
              return Padding(
                padding: const EdgeInsets.all(20.0),
                child: FlatButton(
                  //color: isSelected ? Colors.blue : Colors.red,
                  ...
                  onPressed: () {
                    if (!slot.isAvailable) {
                      ...
                      Fluttertoast.showToast(
                          msg:
                              'Espacio no disponible', //Strings.slotIsNotAvailable,
                          backgroundColor: Colors.red,
                          textColor: Colors.white);
                    } else {
                      setState(() {
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    if (!slot.isAvailable) {
                      ...
                      Fluttertoast.showToast(
                          msg:
                              'Parqueo no disponible', //Strings.slotIsNotAvailable,
                          backgroundColor: Colors.red,
                          textColor: Colors.white);
                    } else {
                      setState(() {
